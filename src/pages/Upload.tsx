      ...
      <div className="mx-auto max-w-4xl space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Importe arquivos Excel com dados de vendas para análise
          </p>
        </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setCurrentConfig((c) => ({ ...c, subgroup: e.target.value }))
                  }
                />
              </div>
            </div>
              ...
              <div className="flex flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed border-border bg-muted/30 p-8 transition-colors hover:border-primary hover:bg-muted/50">
                ...
                <div className="text-center">
                  <p className="font-medium text-foreground">
                    Clique ou arraste arquivos Excel
                  </p>
        ...
        {pendingFiles.length > 0 && (
          <Card className="border-border bg-card shadow-card animate-slide-up">
            <CardHeader>
              ...
              <CardDescription>
                Revise os arquivos antes de confirmar o upload
              </CardDescription>
            </CardHeader>
